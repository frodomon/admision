...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { obs: @observation.obs, observation_type_id: @observation.observation_type_id } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { obs: @observation.obs, observation_type_id: @observation.observation_type_id } }
